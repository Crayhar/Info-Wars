      ...
      <div className={`article ${activeIndex === sentences.length ? 'visible' : ''}`}>
        ...
        <section>
            ...
            <section>
                <h2>2017</h2>
                <p>
                Through the years of tests, Rush could finally unveil his “Magnum Opus” so to say; the Titan. But it would seem all was not well in OceanGate-ville. Shortly after the announcement of the Titan, which could supposedly reach down to the titanic numerous professionals in the field urged rush to stop and slow down. <a href="https://www.nytimes.com/2023/06/23/us/titan-safety-warnings-titanic.html">NYTimes</a> 
                </p>
                <p>
