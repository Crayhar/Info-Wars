...
import oceangate from "../photos/oceangate.png"


export default function Oceangate() {
    return(
        <main>
            <div>
                <p>June 18th, 2023</p>
            ...
            <div>
                <p>370 miles off the coast of Newfoundland, Canada</p>
            </div>
            <div>
                <p>A company called OceanGate sent a submarine down to look at the Titanic as a tourist tour</p>
            </div>
            <div>
                <p>The submersible imploded due to the pressure, killing 4 paying customers and the company’s CEO, who was piloting the vehicle.</p>
            </div>
            <div>
                <p>5 people died while looking at the remains of the Titanic which had sunk there over 100 years ago</p>
            </div>
            <section>
            ...
            <section>
                <h2>2009</h2>
                <p>Rush was proven correct. However, despite the market for undersea tourism (https://www.popsci.com/deep-sea-tourism/) consumers commonly believed that submarines were very dangerous, something he believed was “understandable but illogical.” (https://www.smithsonianmag.com/innovation/worlds-first-deep-diving-submarine-plans-tourists-see-titanic-180972179/) Thus OceanGate was founded with his co-partner Guillermo Söhnlein (https://www.miamitodaynews.com/news/120705/story2.shtml) with the mission of promoting undersea tourism while also gaining funding for more and better research into underwater exploration.
                </p>
            </section>
            ...
            <section>
                ...
                <img src={oceangate} alt="Image of the oceangate submarine" />
                <p>
